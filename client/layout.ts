...
export const layout = `
  ...
  <main>
    ...
    <section class="mechanics-strip" aria-label="How to play">
      ...
      <div class="item-rule"><span class="item-icon" aria-hidden="true">⬡</span><strong>Armor <b>${RTS_CONFIG.prices.armor} CR</b></strong><p>Drones start unarmored. Buy one-hit protection for ${RTS_CONFIG.prices.armor} salvage. It absorbs one bullet or collision, then breaks and alerts the drone.</p></div>
    ...
    <details class="network-lab panel"><summary class="network-heading"><div><span class="eyebrow">NETWORK LAB</span><h2>Inspect the peer mesh</h2><p>Native Zenoh peers and MAVLink packets. Isolate a drone to interrupt its team radio.</p></div><span id="network-status">Launch the match to connect.</span></summary><div class="network-peers" id="network-peers"></div><p class="network-note">An isolated drone keeps sensing and following its last received mission. Radio traffic queues until reconnection or expiry. These loopback connections simulate partitions, not RF propagation.</p></details>
      <section class="overview-panel panel" aria-label="Live overhead map">
        <header class="panel-header"><div><span class="eyebrow">SPECTATOR TACTICAL MAP</span><h2>Downtown Cincinnati <span class="map-live"><i></i> LIVE</span></h2></div><div class="map-actions"><button class="button button-stop" id="map-downtown">Fit downtown</button></div></header>
    ...
    <footer class="page-footer"><span><span class="footer-mark">F</span> Downtown Cincinnati, simplified. <a href="https://www.openstreetmap.org/copyright" target="_blank" rel="noreferrer">Map data © OpenStreetMap contributors</a><a href="https://services.arcgis.com/JyZag7oO4NteHGiq/ArcGIS/rest/services/Open_Data_Feature_Collection/FeatureServer" target="_blank" rel="noreferrer">River: CAGIS</a></span><span id="session-id">Two swarms. Six independent pilots.</span></footer>
  </main>`;
