...
- Player-visible scores, map markers, inventories and world state are not agent observations. Mining requires private recent camera evidence and physical reach; never expose a resource locator or arbitrary target IDs. Buying appears only after team salvage is recovered, firing only after that drone has a gun. Own equipment and unlocked team balance are allowed interaction feedback. Shots must follow actual aim and collide physically, without enemy-ID targeting or hidden hit receipts.
